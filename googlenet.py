...
def roc(lstm_predictions,y_pre_temp):
    ...
    csv_file1 = open('.../googlenet.csv', 'w', newline='')
    ...
    csv_file2 = open('.../googlenet.csv', 'w', newline='')
    ...
    plt.xlabel('FP Rate')
    plt.ylabel('TP Rate')
    plt.title('ROC curves of GooLeNet to classify four classes')
...
def drawlines(history):
    ...
    csv_file = open('.../googlenet.csv', 'w', newline='')
