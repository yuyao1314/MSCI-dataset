...
def cnn_model(x_train, y_train,x_test, y_test):
    model = Sequential()
    model.add(Conv2D(96, (11, 11), strides=(4, 4), input_shape=(x_train.shape[1],x_train.shape[2], x_train.shape[3]), padding='valid', activation='relu',
    ...
    model.save('/home/som/lab/seed-yzj/paper1/kerasacedic/alexacetic/alexacetic_model.h5')
...
def roc(lstm_predictions,y_pre_temp):
    ...
    csv_file1 = open('/home/som/lab/seed-yzj/paper1/kerasacedic/alexacetic/myfprcsv.csv', 'w', newline='')
    ...
    csv_file2 = open('/home/som/lab/seed-yzj/paper1/kerasacedic/alexacetic/mytprcsv.csv', 'w', newline='')
    ...
    plt.title('ROC curves of C-RCNN to classify four classes')
...
def drawlines(history):
    ...
    csv_file = open('/home/som/lab/seed-yzj/paper1/kerasacedic/alexacetic/alexacetic.csv', 'w', newline='')
...
if __name__ == '__main__':
    trainpath = '/home/som/lab/seed-yzj/safeyolo/cervical/data/384/train'
    testpath = '/home/som/lab/seed-yzj/safeyolo/cervical/data/384/test'
    traintxt = '/home/som/lab/seed-yzj/safeyolo/cervical/data/train_records.txt'
    testtxt = '/home/som/lab/seed-yzj/safeyolo/cervical/data/test_records.txt'
