...
def cnn_model(x_train, y_train,x_test, y_test):
    ...
    model.save('/home/som/lab/yuyao/yuyao1/paper1/kerasacedic/resacetic/resacetic_model.h5')
...
def roc(lstm_predictions,y_pre_temp):
    ...
    csv_file1 = open('/home/som/lab/yuyao/yuyao1/paper1/kerasacedic/resacetic/resfprcsv.csv', 'w', newline='')
    ...
    csv_file2 = open('/home/som/lab/yuyao/yuyao1/paper1/kerasacedic/resacetic/restprcsv.csv', 'w', newline='')
    writer = csv.writer(csv_file2)
    for key in tpr:
        writer.writerow([key, tpr[key]])
    csv_file2.close()
    # fprcsv = pd.DataFrame(fpr)
    # fprcsv.to_csv('/home/som/lab/yuyao/yuyao1/paper1/kerasacedic/myfprcsv.csv')
    # tprcsv = pd.DataFrame(tpr)
    # tprcsv.to_csv('/home/som/lab/yuyao/yuyao1/paper1/kerasacedic/mytprcsv.csv')
...
def drawlines(history):
    ...
    csv_file = open('/home/som/lab/yuyao/yuyao1/paper1/kerasacedic/resacetic/resacetic.csv', 'w', newline='')
