...
def cnn_model(x_train, y_train,x_test, y_test):
    ...
    model.save('/home/som/lab/seed-yzj/paper1/finalex/2dfinal/2dfinal.h5')
...
def roc(lstm_predictions,y_pre_temp):
    ...
    csv_file1 = open('/home/som/lab/seed-yzj/paper1/finalex/2dfinal/2dfinalfprcsv.csv', 'w', newline='')
    ...
    csv_file2 = open('/home/som/lab/seed-yzj/paper1/finalex/2dfinal/2dfinaltprcsv.csv', 'w', newline='')
    ...
    plt.xlabel('FP Rate')
    plt.ylabel('TP Rate')
    plt.title('ROC curves of Only-CNN to classify four classes')
...
def drawlines(history):
    ...
    csv_file = open('/home/som/lab/seed-yzj/paper1/finalex/2dfinal/2dfinal.csv', 'w', newline='')
